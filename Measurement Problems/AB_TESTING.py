...
# Maximum Biddingle Average Bidding arasında anlamlı bir farklılık yoktur
# H0 : M1 = M2 
# Maximum Biddingle Average Bidding arasında anlamlı bir farklılık vardır
# H1 : M1!= M2
...
#p-value > 0.05 ten büyük olduğu için H0 reddedilemez anlamlı bir farklılık yoktur
